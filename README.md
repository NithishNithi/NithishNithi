...
const MrNithishT = {
  ...
  experience: "3+ years",
  focus: [
    "multi-account / multi-region AWS operations",
    "zero-downtime deploys (Nomad, CodeDeploy, ALB target-group swaps)",
    "cloud cost analysis & cost-allocation tagging",
    "nginx / Caddy config, TLS hardening, DNS + ALB routing",
    "incident response and post-incident runbooks",
  ],
  learning: [
    "Go",
    "Cloud Architecture",
    ...
    "SRE fundamentals (JVM internals, stateful systems)",
  ],
  askMeAbout: [
    "DevOps",
    "AWS (EC2, ECS, EFS, ALB, Lambda, ACM, SSM, CloudWatch)",
    "CI/CD pipelines",
    "Kubernetes",
    "Terraform",
  ...
  techStack: {
    ...
    cicd: ["Jenkins", "GitHub Actions", "AWS CodePipeline", "AWS CodeDeploy"],
    infraAsCode: ["Terraform", "CloudFormation"],
    webServers: ["nginx", "Caddy"],
    messaging: ["NATS / JetStream", "Kafka"],
    monitoring: ["Prometheus", "Grafana", "CloudWatch"],
    security: ["SonarQube", "Trivy", "IAM", "WAF", "ACM / TLS", "GPG", "SSM Session Manager"],
  ...
  hobbies: {
    ...
    games: ["Star Trek Fleet Command"],
    funFact: {
      secret: ["I freaking love music 🎵"],
      other: ["proud German Shepherd dad 🐕"],
    },
  },
  education: {
